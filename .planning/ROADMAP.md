...
- [x] 05-04-PLAN.md — Scene engine: single-rAF scene.ts, pause state machine {hidden, fig01-active, reduced-motion}, Layer 2 twinkle + fireflies

**Wave 4** *(blocked on 05-04 + 05-02)*

- [x] 05-05-PLAN.md — Constellations: render + panel-reactive brighten/dim (nightsky:panel-change) + quiet link-firing (Fig. 01 beam math mirrored)
