...
- [x] 02-01-PLAN.md — Foundations: source-annotated fact data, runtime token reader, pure model.ts topology + beam/fault state machine (wave 1)
...
- [x] 02-04-PLAN.md — Figure01.astro chrome + ARIA surface + 10 proxy buttons + bare bundling script; index.astro slot fill (wave 4)
...
- [x] 03-02-PLAN.md — /work/[slug].astro case-study pages (header+footer, metrics strip, problem/approach/impact) + link the two systems-list rows (wave 2)

**Wave 3** *(blocked on Wave 2)*

- [ ] 03-03-PLAN.md — SEO partial in BaseLayout + static OG image (sharp) + @astrojs/sitemap@3.7.3 + robots.txt (wave 3)
...
| 3. Case Studies & Launch Polish | 2/4 | In Progress|  |
