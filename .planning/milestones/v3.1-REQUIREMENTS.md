...
- [x] **BOLD-06**: All gates re-pass on the new look — LOCAL portion (11-03) + LIVE portion (Phase 12) both COMPLETE. Local: `verify-visibility.mjs` re-blessed to the approved stills + green ×3 viewports, blur/blackout controls still fail; `--cdp-screenshot` ≥4.5:1 every surface both viewports held by the card, never by re-darkening the sky; `--moon`/`--aurora`/banding green; soak 6.96% <10%; local Lighthouse 99-100 ×8. **LIVE (deployed 2026-07-20):** FF-pushed to origin, GitHub Actions green; `verify-visibility --gate` GREEN ×3 viewports on the LIVE origin (SSIM 0.9999/0.9998/0.9996 — the bold sky provably renders live); live Lighthouse desktop 100/100/100/100 + mobile 99/100/100/100 (no category <90); deploy gated on explicit user "Deploy now" go
...
| BOLD-06 | Phase 11 + 12 | Complete (local gates 11-03; live gate + user-gated deploy Phase 12 — shipped 2026-07-20) |

**Coverage:** 6 total · mapped 6 · unmapped 0 · **complete 6/6**
